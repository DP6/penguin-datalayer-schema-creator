addEdit.onclick = function () {
  ...
  schema.array.items[selectEvents.selectedIndex - 1].properties.event.enum = [eventNameEdit]; //returns the name to be changed
...
btnAddPropertyPopup.onclick = function () {
  ...
  if (newProperty.name !== '') {
    ...
    currentSchemaObject[newProperty.name] = currentSchemaObject[oldPropertyName]; //replaces a property name
  ...
  if (newProperty.requiredOption === 'required') {
    schema.array.items[selectEvents.selectedIndex - 1].required[selectProps.selectedIndex] = newProperty.name;
  }

  if (newProperty.requiredOption === 'nonRequired') {
    schema.array.items[selectEvents.selectedIndex - 1].required.splice([selectProps.selectedIndex]);
  }
...
btnAddPropertyPopupNv2.onclick = function () {
  ...
  if (newProperty.name !== '') {
    ...
    switch (
      ...
      case 'string':
        if (newProperty.validationType === 'enum') {
          currentSchemaObject[oldPropertyName].properties[newProperty.name] = currentSchemaObject[
            oldPropertyName
          ].properties[oldPropertyName2] = {
            type: 'string',
            enum: newProperty.value.split(','),
          };
      ...
      case 'object':
        if (currentSchemaObject[oldPropertyName].properties[newProperty.name].properties === {}) {
          currentSchemaObject[oldPropertyName].properties[newProperty.name] = currentSchemaObject[
            oldPropertyName
          ].properties[oldPropertyName2] = {
            type: 'object',
    ...
    if (newProperty.requiredOption === 'nonRequired') {
      currentSchemaObject[oldPropertyName].required.splice([selectProps3.selectedIndex]);
    }
...
btnAddPropertyPopupNv3.onclick = function () {
  ...
  if (newProperty.name !== '') {
    ...
    currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[newProperty.name] =
      currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3]; //replaces a property name
    delete currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3]; // delete the old name
    ...
    if (newProperty.requiredOption === 'nonRequired') {
      currentSchemaObject[oldPropertyName].properties[oldPropertyName2].required.splice([selectProps3.selectedIndex]);
    }
...
btnAddPropertyPopupNv4.onclick = function () {
  ...
  if (newProperty.name !== '') {
      ...
      case 'object':
        if (
          ...
          currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[
            ...
            currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[
              newProperty.name
            ]; // This line of code serves to replace the object's name. newProperty.name receives the oldPropertyName information along with the dataLayer information contained in CurrentSchema.The third newProperty.name receives all the information along with the object's new name.The delete erases the oldPropertyName information, so as not to have duplicate objects.
          delete currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3]
            .properties[oldPropertyName4];
        }
        break;
    ...
    // property modes selection conditionals
    if (newProperty.requiredOption === 'required') {
      currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].required = [
        newProperty.name,
      ];
    }
...
btnAddPropertyPopupNv5.onclick = function () {
  ...
  if (newProperty.name !== '') {
    ...
    currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[
      ...
      currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[
        oldPropertyName4
      ].properties[oldPropertyName5]; //replaces a property name
    delete currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[
      oldPropertyName4
    ].properties[oldPropertyName5]; // delete the old name
    ...
    switch (
      ...
      case 'string':
        if (newProperty.validationType === 'enum') {
          currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[
            oldPropertyName4
          ].properties[newProperty.name] = currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[
            oldPropertyName3
          ].properties[oldPropertyName4].properties[oldPropertyName5] = {
            type: 'string',
            enum: newProperty.value.split(','),
          };
          delete currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3]
      ...
      case 'object':
        if (
          currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[
            oldPropertyName4
          ].properties[newProperty.name].properties === {}
        ) {
          currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[
            oldPropertyName4
          ].properties[newProperty.name] = currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[
    ...
    if (newProperty.requiredOption === 'required') {
      currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[
        oldPropertyName4
      ].required = [newProperty.name];
    }

    if (newProperty.requiredOption === 'nonRequired') {
      currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[
        oldPropertyName4
      ].required.splice([selectProps5.selectedIndex]);
    }
