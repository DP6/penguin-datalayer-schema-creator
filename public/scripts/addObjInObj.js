btnAddObjectNv2.onclick = function () { //função para adicionar propriedades nivel 2
  ...
  let selectedPropertyValue = selectProps.children[selectProps.selectedIndex].value; // pega o valor da propriedade selecionada, para criar os caminhos no dataLayer
      ...
      if (selectedPropertyValue === "Properties") {
        ...
        switch (propertyType.value) {//pega o valor do tipo de propriedade selecionada
          case "string":
        ...
        if (propertyRequired.value === "required") {//seleção do valor required ou non required
...
btnAddObjectNv3.onclick = function () {//função para adicionar propriedades nivel 3
  let newPropertyOption = new Option(propertyName.value, propertyName.value);
...
btnAddObjectNv4.onclick = function () {//função para adicionar propriedades nivel 4
  let newPropertyOption = new Option(propertyName.value, propertyName.value);
  let selectProps = document.querySelectorAll("#propertySelected")[0];
  let selectProps2 = document.querySelectorAll("#propertyNv2")[0];
...
btnAddObjectNv5.onclick = function () {//função para adicionar propriedades nivel 5
  let newPropertyOption = new Option(propertyName.value, propertyName.value);
  let selectProps = document.querySelectorAll("#propertySelected")[0];
  let selectProps2 = document.querySelectorAll("#propertyNv2")[0];
  let selectProps3 = document.querySelectorAll("#propertyNv3")[0];
