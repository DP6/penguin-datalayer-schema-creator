...
btnRemovePropertyNv4.onclick = function () {
  ...
  let currentSchemaObject =
    schema.array.items[selectEvents.selectedIndex - 1].properties
  ...
  delete currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[oldPropertyName4]
      ...
      currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].required.splice(selectProps4.selectedIndex,1)
...
btnRemovePropertyNv5.onclick = function () {
    ...
    delete currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[oldPropertyName4].properties[oldPropertyName5]
        ...
        currentSchemaObject[oldPropertyName].properties[oldPropertyName2].properties[oldPropertyName3].properties[oldPropertyName4].required.splice(selectProps5.selectedIndex,1)
